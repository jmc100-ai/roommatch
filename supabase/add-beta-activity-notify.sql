-- Daily dedupe ledger for home-page Go activity emails (POST /api/activity).
-- One notification email per distinct_id per UTC calendar day.
...
CREATE TABLE IF NOT EXISTS beta_activity_notify (
  ...
  PRIMARY KEY (distinct_id, activity_day)
);
