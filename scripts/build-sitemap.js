    ...
    <div class="mfoot-inner">
      <div class="mfoot-grid">
        <div class="mfoot-col mfoot-brand">
          ...
          <p class="mfoot-tagline">Photo-first hotel discovery.</p>
        </div>
        <div class="mfoot-col">
        ...
        <div class="mfoot-col">
          <p class="mfoot-heading">Company</p>
          <ul class="mfoot-links">
            <li><a href="__ORIGIN__/privacy">Privacy</a></li>
            <li><a href="__ORIGIN__/terms">Terms</a></li>
            <li><a href="__ORIGIN__/destinations">Destinations hub</a></li>
            <li><a href="__ORIGIN__/sitemap.xml">XML sitemap</a></li>
          </ul>
        </div>
      </div>
      <div class="mfoot-bottom">
        <p>© 2026 TravelBoop, LLC. All rights reserved.</p>
      </div>
    </div>
  </footer>
</body>
