...
const SEO_META = {
  ...
  "paris-boutique-hotels": {
    ...
    h2Intro: "Best boutique hotels in Paris by neighbourhood",
  ...
  "hotels-in-le-marais": {
    ...
    heroAlt: "Le Marais Paris hotel neighbourhood, Musée Picasso garden",
  },
  "hotels-in-saint-germain": {
    ...
    heroAlt: "Saint-Germain-des-Prés Paris Left Bank neighbourhood",
  },
  "hotels-in-montmartre": {
    ...
    heroAlt: "Montmartre Paris hillside neighbourhood at dusk",
  },
  ...
  "montmartre-vs-marais": {
    ...
    desc: "Montmartre vs Le Marais — village hills or central cobblestones? Compare neighbourhoods, then find Paris hotels by vibe.",
  },
  ...
  "mexico-city-boutique-hotels": {
    ...
    h2Intro: "Best boutique hotels in Mexico City by neighbourhood",
  ...
  "mexico-city-local-neighborhood-hotels": {
    title: "Best Neighbourhood Hotels in Mexico City",
    h1: "Best Neighbourhood Hotels in Mexico City",
    desc: "Local-feeling Mexico City hotels in Condesa, Roma Norte, and Juárez — residential rhythm, mercados, and corner cantinas.",
    h2Intro: "Best local neighbourhood hotels in CDMX",
    h2Featured: "Neighbourhood-led hotel picks",
  },
  ...
  "hotels-in-condesa": {
    ...
    heroAlt: "Condesa Mexico City leafy neighbourhood park",
  },
  ...
  "hotels-in-juarez": {
    ...
    heroAlt: "Juárez Mexico City central neighbourhood near Reforma",
  },
  ...
  "condesa-vs-polanco": {
    ...
    desc: "Condesa vs Polanco — leafy calm or luxury polish? Compare CDMX neighbourhoods, then search hotels by room photos.",
  },
  "roma-norte-vs-condesa": {
    title: "Roma Norte vs Condesa: Where to Stay in CDMX",
    desc: "Roma Norte vs Condesa — trendy energy or park-side calm? Compare Mexico City neighbourhoods and hotel vibes.",
  },
  "juarez-vs-condesa": {
    title: "Juárez vs Condesa: Where to Stay in Mexico City",
    desc: "Juárez vs Condesa — central Reforma access or leafy residential calm? Compare CDMX hotel neighbourhoods.",
  },
