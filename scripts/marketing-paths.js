...
const MARKETING_ROUTES = [
  ...
  { path: "/hotels-in-condesa", file: "hotels-in-condesa.html", title: "Hotels in Condesa, Mexico City", city: "Mexico City", category: "neighbourhood" },
  { path: "/hotels-in-roma-norte", file: "hotels-in-roma-norte.html", title: "Hotels in Roma Norte, Mexico City", city: "Mexico City", category: "neighbourhood" },
  { path: "/hotels-in-polanco", file: "hotels-in-polanco.html", title: "Hotels in Polanco, Mexico City", city: "Mexico City", category: "neighbourhood" },
  { path: "/hotels-in-juarez", file: "hotels-in-juarez.html", title: "Hotels in Juárez, Mexico City", city: "Mexico City", category: "neighbourhood" },
  { path: "/hotels-in-centro-historico", file: "hotels-in-centro-historico.html", title: "Hotels in Centro Histórico, Mexico City", city: "Mexico City", category: "neighbourhood" },
  ...
  { path: "/where-to-stay-in-paris", file: "where-to-stay-in-paris.html", title: "Where to Stay in Paris — Hotels by Neighbourhood", city: "Paris", category: "hub" },
  { path: "/paris-neighborhood-stays", file: "paris-neighborhood-stays.html", title: "Paris Hotels by Neighbourhood — Where to Stay", city: "Paris", category: "hub" },
  ...
  { path: "/hotels-in-saint-germain", file: "hotels-in-saint-germain.html", title: "Hotels in Saint-Germain, Paris", city: "Paris", category: "neighbourhood" },
  { path: "/hotels-in-montmartre", file: "hotels-in-montmartre.html", title: "Hotels in Montmartre, Paris", city: "Paris", category: "neighbourhood" },
  { path: "/hotels-in-latin-quarter", file: "hotels-in-latin-quarter.html", title: "Hotels in Latin Quarter, Paris", city: "Paris", category: "neighbourhood" },
  { path: "/hotels-in-opera", file: "hotels-in-opera.html", title: "Hotels near Opéra, Paris", city: "Paris", category: "neighbourhood" },
