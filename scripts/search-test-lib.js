...
const SEARCH_TESTS = [
  {
    ...
    description: "V2 feature: double_sinks (KL partial index)",
  },
  {
    id: 2,
    ...
    description: "V2 feature: rainfall_shower (KL partial index)",
  },
  {
    id: 3,
    query: "soaking tub",
    ...
    description: "V2 feature: soaking_tub (KL partial index)",
  },
  {
    id: 4,
    ...
    description: "V2 feature: walk_in_shower (KL partial index)",
  },
  {
    id: 5,
    ...
    minHotels: 30,
    description: "V2 semantic: bright room (KL partial index)",
  },
  {
    id: 6,
    query: "double sinks",
    ...
    source: "v2",
    expectation: { type: "feature", flag: "double_sinks" },
    description: "V2 feature: double_sinks (Paris)",
  },
  {
    id: 7,
    ...
    expectation: { type: "semantic" },
    minHotels: 30,
    description: "Semantic: Art Deco style room (Paris, V2)",
  },
  {
    id: 8,
    query: "balcony",
    ...
    description: "V2 feature: balcony (KL partial index)",
  },
  {
    id: 9,
    query: "city view",
    ...
    description: "V2 feature: city_view (KL partial index)",
  },
  {
    id: 10,
    query: "king bed",
    ...
    description: "V2 feature: king_bed (KL partial index)",
  },
  {
    id: 11,
    ...
    description: "V2 feature: separate_living_area (KL partial index)",
  },
  {
    id: 12,
    ...
    description: "V2 feature: floor_to_ceiling_windows (KL partial index)",
  },
  {
    id: 13,
    query: "balcony",
    ...
    source: "v2",
    expectation: { type: "feature", flag: "balcony" },
    description: "V2 feature: balcony (Paris)",
  },
  {
    id: 14,
    query: "city view",
    ...
    source: "v2",
    expectation: { type: "feature", flag: "city_view" },
    description: "V2 feature: city_view (Paris)",
  },
  {
    id: 15,
    query: "bathtub",
    ...
    description: "V2 feature: bathtub (Paris)",
  },
  {
    id: 16,
    query: "terrace",
    ...
    description: "V2 feature: terrace (Paris)",
  },
  {
    id: 17,
    ...
    description: "V2 feature: landmark_view / Eiffel Tower view (Paris)",
  },
